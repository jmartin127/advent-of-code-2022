...
Future<void> main() async {
  ...
  // find the solution
  print('Running BFS to go to end...');
  var startPos = PointInTime(basin.startPosition, 0);
  var endPos = basin.endPosition;
  final endFirstTime =
      runBreadthFirstSearch(basin, startPos, blizzardsAtPointInTime, endPos);
  print('Done running BFS');
  print('Running BFS to go back to beginning...');
  startPos = endFirstTime!;
  endPos = basin.startPosition;
  final backToStart =
      runBreadthFirstSearch(basin, startPos, blizzardsAtPointInTime, endPos);
  print('Done running BFS');
  print('Running BFS to go back to end...');
  startPos = backToStart!;
  endPos = basin.endPosition;
  final backToEnd =
      runBreadthFirstSearch(basin, startPos, blizzardsAtPointInTime, endPos);
  print('Done running BFS');
  print(backToEnd);
...
PointInTime? runBreadthFirstSearch(Basin basin, PointInTime startPos,
    Map<PointInTime, List<Blizzard>> blizzardsAtPointInTime, Point endPos) {
